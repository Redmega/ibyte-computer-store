...
To set up your workspace either use the Homestead VM or ensure XAMPP is installed along with PHP7.0 and Composer. I suggest using the Homestead VM as mostly everything is taken care of for you.
